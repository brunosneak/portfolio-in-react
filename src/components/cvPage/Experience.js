    ...
    return (
        <section className={ Style.xp }>
            {/* <div className={ Style.lycee }>
                ...
                <img alt="livre" src={require("../../assets/img/formationLycee.png")}/>
            </div>
            <div className={ Style.acf }>
                ...
                <img alt="cartes de jeux" src={require("../../assets/img/formationCroupier.png")}/>
            </div>
            <div className={ Style.croupier }>
                ...
                <img alt="tableau vide" src={require("../../assets/img/fondExperience.svg")}/>
            </div>
            ...
            <div className={ Style.eMultiM }>
                ...
                <img alt="fenêtre html" src={require("../../assets/img/formationDev.png")}/>
            </div>
